package _015_operadoresunarios;

/**
 *
 * @author JUSTCODDEV
 */
public class _015_OperadoresUnarios {
    ...
    public static void main(String[] args) {
        ...
        var i = 2;
        var j = --i;
        System.out.println("i = " + i);//ya ssta decrementada
        System.out.println("j = " + j);

        //2.postdecremento
        var k = 4;
        var l = k--; //primero se usa el valor de la variable y queda pendiente decremento
        System.out.println("k = " + k); //tenia pendiente yn decremento
